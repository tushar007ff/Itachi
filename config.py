...
BOT_USERNAME = getenv("BOT_USERNAME" , "ItachiBot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "Itachi Music")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "ItachiXHelper")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/tushar007ff/Itachi",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "XT")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
